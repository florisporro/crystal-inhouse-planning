...
limit. `sendMagicLink` blocks *unknown* addresses, but any **known** resident
...
intentional "public overview," but publishing *when a specific unit will be empty /
mid-move* is a real physical-security signal for residents (burglary timing).
